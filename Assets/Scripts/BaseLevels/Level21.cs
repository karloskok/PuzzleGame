...
public class Level21 : Level21Base {
    ...
    void Update()
    {
        ...
        if (Time.frameCount % 3 == 0)
        {
            ...
            if (StarttCam.GetComponent<Camera>().enabled && Input.GetKeyDown(KeyCode.Escape))
            {
            ...
            if (leftCam.GetComponent<Camera>().enabled && Input.GetKeyDown(KeyCode.Escape))
            {
            ...
            if (RightCam.GetComponent<Camera>().enabled && Input.GetKeyDown(KeyCode.Escape))
            {
